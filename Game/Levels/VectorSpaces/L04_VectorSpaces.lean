...
Introduction "In this level we prove that if u + v = v then u must be the zero vector. This is the cancellation law, and uses the existence of additive inverses."
