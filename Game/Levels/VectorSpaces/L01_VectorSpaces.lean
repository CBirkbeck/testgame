...
-/
TheoremDoc MyVectorSpace.add_zero as "add_zero" in "VectorSpace"

/--
Vector addition is commutative: `u + v = v + u`.
-/
TheoremDoc MyVectorSpace.add_comm as "add_comm" in "VectorSpace"

/--
Every vector has an additive inverse: `∀ v, ∃ w, v + w = 0 ∧ w + v = 0`.
-/
TheoremDoc MyVectorSpace.add_inv as "add_inv" in "VectorSpace"

/--
Vector addition is associative: `(u + v) + w = u + (v + w)`.
-/
TheoremDoc MyVectorSpace.add_asoc as "add_asoc" in "VectorSpace"

/--
Scalar multiplication distributes over vector addition: `α • (v + w) = α • v + α • w`.
-/
TheoremDoc MyVectorSpace.smul_add as "smul_add" in "VectorSpace"
...
-/
TheoremDoc MyVectorSpace.add_perm4 as "add_perm4" in "VectorSpace"
